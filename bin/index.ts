...
// 一旦完成ということで！
// FargateSpotにしたい、もしくはEC2にしたい ← やったけど本当にspotになっているか確認
// あとはpecoか何かを入れてタスクランナーをいい感じにしたい感じ
// あとimportをアスタにしておきたい。読みづらいし
// あとtask definitionを前にすすめる方法を模索したい
// CPUアーキテクチャをarm64に変更 なぜかx86_64で動いている...キモチワルイ
// publicIPをもつ方法も手段として理解しておきたい vpceとかNATだけだとちょっとお金がね...
app.synth();
